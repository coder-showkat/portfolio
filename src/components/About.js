  ...
  return (
    <div id="about" className="section" ref={ref}>
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 min-h-[992px] h-screen">
          {/* img */}
          <motion.div
          ...
          >
            ...
            <p className="mb-6">
              ...
              laudantium fugit delectus voluptatum repudiandae, molestias.
            </p>
